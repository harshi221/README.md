...
📂 Project Structure
hotels-and-rooms/ │ ├── app.py # Main backend application ├── travel_booking.db # SQLite database (auto-created) │ ├── index.html # Homepage ├── login.html # Login page ├── signup.html # Registration page ├── unified-dashboard.html # Main dashboard (User + Admin) ├── packages.html # Browse packages ├── booking.html # Booking form ├── contact.html # Contact us page ├── about_us.html # About page ├── destinations.html # Destinations page │ ├── images/ # All images used in the project │ ├── image1.jpg │ ├── goa.jpg │ ├── ooty.jpg │ ├── coorg.jpg │ ├── manali.jpg │ ├── mysore.jpg │ └── kerala.jpg │ └── README.md # This file
